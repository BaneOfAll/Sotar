...
exports.commands = {
    addteam: function(target, user, room) {
       // if (!['noxiousabyss', 'pixelpusher'].includes(toId(this.by))) return false;
        ...
        if (!author || !link || team.length < 6) return this.send(".addteam author, link, mon 1, mon 2...");
    ...
    sampleteams: function(target, user, room) {
        ...
        let display = `<center><div style="background: linear-gradient(red, blue) ; border: 2px solid purple ; border-radius: 20px"><img src="https://i.imgur.com/tbhAES5.png" width="320" height="80"></div><br><font style="color: Black; font-family: Arial"><div style="border: 4px solid blue ; background: lightblue ; border-radius: 20px">If you want your 1v1 Team added to the bot PM Pixel Pusher to have it added.<br>Click on the sprites for the importable.</div></font></center><br><table style="width: 100%; background-color: #252357 ; color: black ; border: 2px solid Black ; padding: 2px; border-radius: 9px" cellspacing="2" cellpadding="3" border="1"><tbody><tr><th style="color: White; border-radius: 9px ; border: 2px solid Black ; background: #5954b0 ; font-family: Arial; width: 30%">Author</th><th style="color: White;border-radius: 9px ; border: 2px solid Black ; background: #5954b0 ; font-family: Arial">1v1 Team</th></tr>`;
        ...
        for (let i = 0, len = teams.length; i < len; i++) {
            ...
            display += `<tr><td style="color: #FFF; border-radius: 9px; border: 2px solid #000; background: #5954B0; font-family: Arial; text-align: center;"><strong><button style="background: linear-gradient(red, blue) ; border: 2px solid purple ; border-radius: 20px" class="astext" name="parseCommand" value="/user ${author}"><font color="yellow">${author}</font></button></strong></td><td style="color: #FFF; border-radius: 9px; border: 2px solid #000; background: #5954B0; font-family: Arial;"><a style="color: #FFF; text-decoration: none;" href="${link}"><center>`;
